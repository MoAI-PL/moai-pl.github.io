const MoAI = (() => {
	...
	const strings = {
		...
		en: {
			'meta.index.title': 'MoAI – Artificial Intelligence Student Research Club',
			'meta.index.desc': 'MoAI at Lublin University of Technology – student research club for artificial intelligence, machine learning, programming, computer networks and cybersecurity. Join us!',
			'meta.events.title': 'MoAI - Events',
			'meta.events.desc': 'MoAI events at Lublin University of Technology: contests, hackathons, academic conferences and workshops by the AI student research club.',
			...
			'meta.members.desc': 'Meet the members of MoAI at Lublin University of Technology – students behind the AI research club.',
			'meta.thanks.title': 'MoAI – Thank you',
			'meta.thanks.desc': 'MoAI at Lublin University of Technology – thank you for your interest. Check recruitment status and get in touch.',
			'nav.events': 'Events',
			...
			'preloader': 'Loading the page',
			'noscript': 'This page needs JavaScript for animations and project shuffling.',
			'hero.title': 'Your start <span class="hero-title__line">in creating</span> <span class="hero-title__line">tomorrow’s technology</span>',
			'hero.lead': 'MoAI Artificial Intelligence Student Research Club <span class="hero-lead__line">at Lublin University of Technology.</span>',
			'hero.join': 'Join MoAI',
			'hero.write': 'Write to us',
			'who.title': 'Who we are',
			'who.body': 'Hi! We are the MoAI team at Lublin University of Technology. We are passionate about practical AI. We actively promote AI skills and knowledge, and bring together top students from four faculties of the university.',
			'members.seeAll': 'See everyone',
			'events.title': 'Events',
			'events.body': 'We take part in contests, hackathons, academic conferences, business meetings, seminars and campus events. <br> We also organise our own events aligned with the MoAI mission.',
			'events.all': 'Full list of events',
			'events.pageTitle': 'Events',
			'events.pageBody': 'We keep growing — we gladly join technology, business and academic events. See where we have been:',
			...
			'projects.all': 'Full list of projects',
			'projects.pageTitle': 'Selected projects',
			'projects.pageBody': 'We put practice first. Our interdisciplinary team loves learning and solving new problems. See what we have built:',
			'join.title': 'Join MoAI',
			'join.body': 'Build a portfolio, step into the world of business, meet people and gain future-ready skills. Learning is more than a degree...',
			'join.cta': 'Recruitment',
			'follow.title': 'Follow us',
			'follow.body': 'Don’t miss events, workshops and news.',
			'contact.title': 'Want to collaborate?',
			'contact.body': 'Got an idea? Want to set up a meeting or visit us on campus? Send us a message — we will reply as soon as we can.',
			'footer.rules': 'Statute',
			'footer.wz': 'Faculty of Management, Lublin University of Technology',
			'invite.name': 'We are waiting for you',
			'invite.cta': 'Join us',
			'members.ctaTitle': 'All members',
			'members.ctaCopy': 'Meet the whole team and open their LinkedIn profiles.',
			'members.ctaBtn': 'Full team',
			'members.hero': 'Meet every MoAI member',
			'members.intro': 'Everyone brings a unique mix of skills: AI, business, design, operations and community.',
			'members.listCta': 'Go to the list',
			'members.listTitle': 'Full list',
			'members.listBody': 'Click to open a LinkedIn profile.',
			'thanks.pill': 'Thank you for your interest',
			'thanks.title': 'We are not recruiting right now',
			'thanks.body': 'If you still want to work with us, write to <a href="mailto:moai@pollub.edu.pl">moai@pollub.edu.pl</a>. We reply as soon as we can.',
			'thanks.write': 'Write to us',
	...
	const PROJECT_EN = {
		braidak: {
			description: 'Winning AI assistant for the City of Lublin. Zero-cloud RAG on the Bielik model, ChromaDB, TTS and a readable POI map — sovereign AI on the city’s unstructured data.',
			alt: 'brAIdak project graphic: an AI assistant for the City of Lublin.'
		},
		'banking-innovation': {
			description: 'Winning project of the 4th SFB edition. An intelligent system that detects threats for bank clients and sends targeted alerts to the most exposed groups.',
			alt: 'Banking Innovation graphic: threat detection and alerts for bank clients.'
		},
		'obrona-cywilna': {
			title: 'Next-generation civil defence',
			description: 'LubSHIELD web app with a citizen layer and a crisis-management dashboard for local governments. A clear interface for peacetime and emergencies.',
			alt: 'LubShield graphic: a geospatial decision dashboard for the Marshal of the Lublin Voivodeship.'
		},
		ledger: {
			description: 'Civil42 2026 hackathon project: pre-seeded wallets and an offline transaction console for crisis scenarios and field logistics — with online, network-partition and emergency modes.',
			alt: 'Secure Enclave Wallets dashboard: crisis wallets and an offline transaction console.'
		},
		moodify: {
			description: 'A recommender that turns a mood description and a chosen genre into a personalised playlist. Mood and genre go in — a set of tracks for the moment comes out.'
		},
		inticheck: {
			description: 'A neural-network dermatology triage system. It ranks skin-image cases by risk and always leaves the final clinical decision to a doctor.'
		},
		taxifleet: {
			description: 'A platform for monitoring and analysing taxi-fleet drivers. It collects signals from every ride and surfaces team deviations before they show up in settlements.'
		},
		'planet-twin': {
			title: 'Digital twin of a planet',
			description: 'Winning Hack4Sages project — a digital twin of exoplanet TRAPPIST-1e called ExoStress Twin. On NASA data it simulates climate and water-mass transport in real time, including stellar flares and their effect on biosignatures.'
		},
		'promo-wz': {
			title: 'Promoting the Faculty of Management',
			description: 'The MoAI president launched a Faculty of Management promotion team of students and staff. The team built a promotion strategy, marketing campaigns and will refresh student outreach channels.',
			alt: 'Promotion materials of the Faculty of Management at Lublin University of Technology.'
		},
		bydgo: {
			description: 'An interactive guide to Bydgoszcz, built at HackNation for the Ministry of Sport and Tourism. A map, routes and visit stats help explore the city at your own pace.',
			alt: 'BydGO app mockup: a map of Bydgoszcz, routes and visit statistics.'
		},
		'ml-admin': {
			title: 'ML for public administration',
			description: 'Legis 2.0 from HackNation: ML models that analyse legal acts and keep them consistent, with layers for officials and citizens — plain-language law without sending data to a foreign cloud.',
			alt: 'Legis 2.0 login screen: law that understands you, sign-in via the National Node.'
		},
		'esa-agri': {
		...
		slower: {
			description: 'A CASSINI hackathon app: slow-travel navigation on Copernicus data. It looks for the lowest-CO₂ route and maps “green oases” instead of only the fastest path.',
			alt: 'slower app mockups: oasis map and eco-route on Copernicus data around Wrocław.'
		},
		'jetbrains-co2': {
			title: 'CO₂ monitor in JetBrains',
			description: 'A JetBrains plugin awarded at the BHL hackathon. It tracks CO₂ from your code in real time, spots inefficient Python patterns and suggests AI-assisted fixes before energy-heavy code ships.',
			alt: 'codeGreen plugin demo in PyCharm: code efficiency and carbon-footprint analysis.'
		},
		cardioscan: {
			description: 'A heart-murmur analysis tool on the CirCor DigiScope dataset — a diagnostic model with sensitivity and specificity around 90%.',
		...
		'plant-nn': {
			...
			alt: 'Smart-cultivation composition: a coding station and basil under an LED lamp.'
		},
		'dynamic-ui': {
			title: 'Dynamic user interface',
			description: 'A case study of an AI-assisted dynamic interface, built on a live Comarch brief during the 3rd SFB. The UX/UI layer adapts to user behaviour and guides them through the sales path.'
		},
		julia: {
			title: 'Julia — virtual patient assistant',
			description: 'Julia — a virtual patient assistant and the winning project of the 3rd SFB, built for Luxmed. It books visits, explains procedures, introduces doctors and navigates the clinic website.',
			alt: 'Graphic of Julia, a virtual patient assistant built for Luxmed.'
		},
		onhelo: {
			description: 'A fitness app with medtech elements, winner of the 2nd Student Business Festival. Machine-learning models watch exercise form and reduce injury risk.',
	...
	const EVENT_EN = {
		'it-unplugged': {
			description: 'We attended the IT Unplugged conference, listening to talks on AI, data engineering, system architecture, cybersecurity and professional wellbeing — and coming back with new contacts in IT.',
			alt: 'IT Unplugged 2026 panel: three people on stage in armchairs, blue lighting and the IT UNPLUGGED sign.'
		},
		'urban-lab': {
			description: 'We took 1st place and the City of Lublin grand prize. We built “brAIdak” — a zero-cloud RAG AI agent on Bielik, with voice access and a POI map.',
			alt: 'MoAI team with a 1st-place diploma at Urban Lab Challenge — Lublin City of Energy.'
		},
		sfb4: {
			title: '4th Student Business Festival',
			description: 'Three MoAI teams joined the 4th SFB, working on briefs from the County Office, CEWAR and UniCredit. We won for the third year in a row — this time with “Banking Innovation” for UniCredit.',
			alt: 'MoAI team and organisers on stage at the 4th Student Business Festival with an 8000 PLN prize cheque.'
		},
		'hackology-2': {
			description: 'Two MoAI teams joined Hackology 2, where participants designed industrial solutions in image processing.',
		...
		cybermil: {
			...
			description: 'The MoAI president and an inter-faculty team represented Lublin University of Technology at the CyberMil Academy Final at a Ministry of National Defence unit in Warsaw.',
			alt: 'Participants of the CyberMil Academy CTF final on 6 May 2026, including people in uniform, in front of the event slide.'
		},
		'erasmus-startup': {
			description: 'We invited Erasmus students to work on business-research projects. We formed two teams that presented at the StartUp Horizon Conference, taking 1st and 2nd place.',
		...
		'bielik-google': {
			...
			description: 'One of our members ran a workshop with Google for Developers and SpeakLeash. Together we launched Bielik LLM infrastructure on Google Cloud, built a BigQuery vector store and orchestrated the full RAG system.',
			alt: 'Participants of the Bielik AI × Google workshop in front of the Bielik Squadron slide.'
		},
		'civil42-2026': {
			description: 'We joined the Civil42 civil-defence hackathon organised by Instytut 42. We built a web app supporting citizens and local governments in crises, testing our skills in practice and meeting civil-security experts.',
		...
		'dni-otwarte-2026': {
			...
			description: 'We prepared an Artificial Intelligence in Business stand at LUT Open Days. We showed AR models, gesture tracking and image editing, talked to future students and gave campus tours.',
			alt: 'MoAI members at a booth with monitors during LUT Open Days 2026.'
		},
		'mit-ai-summit': {
			description: 'A MoAI delegation joined the MIT AI Summit in Warsaw. We listened to experts such as Prof. Włodzisław Duch and Prof. Piotr Sankowski. Talks on the future of AI and resilient systems mixed academic knowledge with industry reality.',
		...
		seminarium: {
			...
			description: 'At the Inter-faculty Research Seminar we presented three projects: TaxiFleet for fleet management, IntiCheck for diagnosing skin lesions from photos, and Moodify for suggesting content from mood.',
			alt: 'Hall during the Inter-faculty Research Seminar: audience and a speaker by the screen.'
		},
		'pollubmy-marketing': {
			description: 'We spoke at Pollubmy Marketing about upstream modelling from the causal-inference family — how ML models help agencies hit business needs and cut campaign cost.',
			alt: 'Aula of the 4th Young Researchers’ Marketing Conference: audience and a screen with the event title.'
		},
		'ensemble-warsaw': {
			title: 'Ensemble AI — Warsaw',
			description: 'We solved every Ensemble AI hackathon task in Warsaw and finished 6th of nearly 50 teams, reaching the final presentations. Topics covered ML in medical diagnostics, molecular biology and LLM security.',
			alt: 'MoAI team on the Ensemble AI stage in Warsaw during the final presentation.'
		},
		hack4sages: {
			description: 'We won the international Hack4Sages among 200+ participants from 6 continents. Our digital twin of TRAPPIST-1e beat teams from Harvard and Cambridge, and in September we present it at the Origins Federation conference at ETH Zürich.'
		},
		'brave-community': {
			title: '2nd Brave Community meetup',
			description: 'We started working with Lublin’s Brave Community at its 2nd meetup. We regularly join later editions and are preparing our own talk for one of the upcoming meetings.',
			alt: 'Participants of the 2nd Brave Community meetup on the aula steps, group photo.'
		},
		'polska-siega-gwiazd': {
		...
		'akademia-inzynierska': {
			...
			description: 'At the 46th Assembly of the Academy of Engineering we presented MoAI’s achievements and plans, representing Lublin University of Technology. We also saw technologies shown by other research clubs live.',
		...
		cassini: {
			description: 'A seven-person MoAI team spent three days at the CASSINI hackathon in Wrocław, looking for uses of ESA satellite data. We built an app that redefines slow travel — personalised routes powered by data straight from orbit.',
		...
		'warsztaty-matematyczne': {
			...
			description: 'We organised a maths workshop for new students — together we revised the basics to make starting university easier and to prepare for the first tests.',
		...
		ghostday: {
			description: 'We went to GhostDay: Applied Machine Learning in Poznań to hear experts and exchange experience with other ML enthusiasts. We came back full of new ideas and contacts.',
			alt: 'GhostDay 2025 stage: a speaker by a slide with formulas, next to the Ghost Day banner.'
		},
		spaceshield: {
			description: 'We reached the SpaceShield hackathon final in Stalowa Wola. Our TITAN project strengthened crisis-communications systems against jamming and eavesdropping.',
			alt: 'MoAI team at the SpaceShield hackathon final in Stalowa Wola.'
		},
		'civil42-2025': {
			description: 'We joined the Civil42 hackathon, building a web app that supports citizens and local governments in crisis situations.',
		...
		sfb2: {
			...
			description: 'We won 1st place at the 2nd Student Business Festival with the OnHelo fitness app — MoAI’s first major success on the business stage.',
			alt: 'MoAI team with a 5000 PLN cheque at the 2nd Student Business Festival, 24 May 2024.'
		},
		'sympozjum-xxxii': {
			...
			alt: 'Aula of the 32nd International Scientific Symposium at LUT, 15–17 May 2024: screen with the title AI – opportunity or threat?'
		},
		pip: {
			title: 'Conference for the 105th anniversary of the National Labour Inspectorate',
			description: 'We spoke at the 105th-anniversary conference of the National Labour Inspectorate on AI in the labour market — regulatory challenges and the opportunities this technology opens for workers and institutions.',
			alt: 'MoAI team speaking at the 105th-anniversary conference of the National Labour Inspectorate.'
		}
	};
